...
public class YoltParser extends Parser {
	...
	public static final int
		...
		LOOP=21, WHILE=22, FUNCTION=23, RETURN=24, GLOBAL=25, STATIC=26, COINS=27, 
		STRING=28, INT=29, BOOLEAN=30, PRINT=31, PROMPT=32, RANDOM=33, EQUALS=34, 
		INT_VALUE=35, COINS_VALUE=36, GOLD=37, SILVER=38, BRONZE=39, BOOLEAN_VALUE=40, 
		STRING_VALUE=41, IDENTIFIER=42, COMMA=43, SEMICOLON=44, COLON=45, PAREN_OPEN=46, 
		PAREN_CLOSE=47, BRACKET_OPEN=48, BRACKET_CLOSE=49, APOSTROPHE=50, COMMENT=51, 
		WS=52;
	public static final int
		...
		RULE_var_declaration = 6, RULE_var_addition = 7, RULE_var_addition_short = 8, 
		RULE_string_addition_short = 9, RULE_prompt_input = 10, RULE_random_input = 11, 
		RULE_if_statement = 12, RULE_else_if_statement = 13, RULE_else_statement = 14, 
		RULE_return_statement = 15, RULE_while_loop = 16, RULE_do_while_loop = 17, 
		RULE_variables = 18, RULE_break_statement = 19, RULE_logic_expr = 20, 
		RULE_compare_values = 21, RULE_print_stmt = 22, RULE_statement = 23, RULE_expr = 24;
	private static String[] makeRuleNames() {
		return new String[] {
			"application", "class_declaration", "function_declaration", "class_call", 
			"function_call", "global_var_declaration", "var_declaration", "var_addition", 
			"var_addition_short", "string_addition_short", "prompt_input", "random_input", 
			"if_statement", "else_if_statement", "else_statement", "return_statement", 
			"while_loop", "do_while_loop", "variables", "break_statement", "logic_expr", 
			"compare_values", "print_stmt", "statement", "expr"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'GLOBAL'", "'STATIC'", "'COINS'", "'WORDS'", "'NUMBER'", "'BOOL'", "'SPEAK'", 
			"'TELL'", "'RANDOM'", "'='", null, null, null, null, null, null, null, 
			null, "','", "';'", "':'", "'('", "')'", "'{'", "'}'", "'\"'", "'//*'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"BREAK", "CLASS", "LOOP", "WHILE", "FUNCTION", "RETURN", "GLOBAL", "STATIC", 
			"COINS", "STRING", "INT", "BOOLEAN", "PRINT", "PROMPT", "RANDOM", "EQUALS", 
			"INT_VALUE", "COINS_VALUE", "GOLD", "SILVER", "BRONZE", "BOOLEAN_VALUE", 
			"STRING_VALUE", "IDENTIFIER", "COMMA", "SEMICOLON", "COLON", "PAREN_OPEN", 
			"PAREN_CLOSE", "BRACKET_OPEN", "BRACKET_CLOSE", "APOSTROPHE", "COMMENT", 
			"WS"
		};
	}
	...
	public final Function_declarationContext function_declaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << COINS) | (1L << STRING) | (1L << INT) | (1L << BOOLEAN))) != 0)) {
				{
				setState(73);
				_la = _input.LA(1);
				if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << COINS) | (1L << STRING) | (1L << INT) | (1L << BOOLEAN))) != 0)) ) {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__0) | (1L << IF) | (1L << LOOP) | (1L << RETURN) | (1L << COINS) | (1L << STRING) | (1L << INT) | (1L << BOOLEAN) | (1L << PRINT) | (1L << IDENTIFIER))) != 0) );
			setState(95);
			match(BRACKET_CLOSE);
			}
		}
	...
	public final Var_additionContext var_addition() throws RecognitionException {
		...
		enterRule(_localctx, 14, RULE_var_addition);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(130);
	...
	public final Var_addition_shortContext var_addition_short() throws RecognitionException {
		...
		enterRule(_localctx, 16, RULE_var_addition_short);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final String_addition_shortContext string_addition_short() throws RecognitionException {
		...
		enterRule(_localctx, 18, RULE_string_addition_short);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(141);
	...
	public final Prompt_inputContext prompt_input() throws RecognitionException {
		...
		enterRule(_localctx, 20, RULE_prompt_input);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Random_inputContext random_input() throws RecognitionException {
		...
		enterRule(_localctx, 22, RULE_random_input);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << SUB) | (1L << PROMPT) | (1L << RANDOM) | (1L << INT_VALUE) | (1L << COINS_VALUE) | (1L << BOOLEAN_VALUE) | (1L << STRING_VALUE) | (1L << IDENTIFIER) | (1L << PAREN_OPEN))) != 0)) {
				{
				setState(154);
				expr(0);
				}
	...
	public final VariablesContext variables() throws RecognitionException {
		...
		enterRule(_localctx, 36, RULE_variables);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final Compare_valuesContext compare_values() throws RecognitionException {
		...
		enterRule(_localctx, 42, RULE_compare_values);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
